...
import com.aisthea.fashion.config.AppConfig;

/**
 * Application-wide constants.
 * UPLOAD_DIR is resolved from application.properties (app.upload.dir) so all
 * parts of the system write to and read from the same directory.
 */
public class Constants {
    ...
    /**
     * Root upload directory, resolved from application.properties (app.upload.dir).
     * Falls back to {user.home}/aisthea_uploads/uploads so the app still works
     * when the property is not set.
     */
    public static final String UPLOAD_DIR =
            AppConfig.getProperty("app.upload.dir",
                    System.getProperty("user.home") + "/aisthea_uploads/uploads");
