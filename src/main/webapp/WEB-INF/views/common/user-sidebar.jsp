        ...
        <aside class="lg:w-1/4">
            <div
                ...
                <div class="flex flex-col items-center mb-6 pb-6 border-b border-slate-200/60">
                    ...
                    <h2 class="font-display font-bold text-lg text-slate-900 mb-2 text-center leading-tight">
                    ...
                    <div
                        ...
                        <span class="material-symbols-outlined text-accent-gold text-[16px]">stars</span>
                        <span class="text-xs font-bold text-accent-gold tracking-wide uppercase">Gold Member</span>
                    </div>
                    <!-- Points Progress -->
                    <div class="w-full px-2">
                        ...
                        <p class="mt-2 text-[10px] text-center text-slate-500 font-medium">500 points to <span
                                class="text-accent-gold font-bold">DIAMOND</span></p>
                    </div>
                </div>
                    ...
                    <details class="group" open>
                        <summary
                            ...
                            <div class="flex items-center text-slate-700 font-medium">
                                <span class="material-symbols-outlined mr-3 text-[20px] text-primary">person</span>
                        ...
                        <div class="pl-11 pr-2 pt-1 pb-2 space-y-1">
                            ...
                            <a class="block py-2 text-sm transition-colors hover:text-primary ${activeTab == 'change_password' ? 'nav-subitem-active' : 'text-slate-500'}"
                                href="${pageContext.request.contextPath}/change-password">Đổi mật khẩu</a>
                            <a class="block py-2 text-sm transition-colors hover:text-primary ${activeTab == 'tier' ? 'nav-subitem-active' : 'text-slate-500'}"
                                href="${pageContext.request.contextPath}/tier-details">Chi tiết hạng thành viên</a>
                        </div>
                    </details>
