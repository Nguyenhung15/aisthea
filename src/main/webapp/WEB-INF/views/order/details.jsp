        ...
        <div class="container mx-auto max-w-6xl p-4 md:p-8 flex-grow">
                ...
                <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-6 rounded-lg shadow-md mb-8" role="alert">
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <p class="text-base">Cảm ơn bạn đã mua sắm tại AISTHÉA. Chúng tôi sẽ xử lý đơn hàng của bạn trong thời gian sớm nhất.</p>
                        </div>
                    </div>
                </div>
            </c:if>
            ...
            <div class="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div class="w-full lg:w-2/3 bg-white rounded-lg shadow-lg p-6">
                    <h2 class="text-xl font-semibold text-gray-700 border-b border-gray-200 pb-4 mb-4">Danh sách sản phẩm</h2>
                ...
                <div class="w-full lg:w-1/3">
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-28">
                        ...
                        <h3 class="text-lg font-semibold text-gray-700 border-b border-gray-200 pb-3 mb-3">Thông tin khách hàng</h3>
                ...
                <form id="cancelForm" action="${pageContext.request.contextPath}/order" method="post">
                    ...
                    <div class="space-y-2 mb-4">
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="reason" value="Đặt nhầm sản phẩm" required onchange="toggleOtherReason()">
                            <span>Đặt nhầm sản phẩm</span>
                        </label>
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="reason" value="Thay đổi địa chỉ giao hàng" onchange="toggleOtherReason()">
                            <span>Thay đổi địa chỉ giao hàng</span>
                        </label>
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="reason" value="Thời gian giao hàng quá lâu" onchange="toggleOtherReason()">
                            <span>Thời gian giao hàng quá lâu</span>
                        </label>
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="reason" value="Tìm thấy giá tốt hơn ở nơi khác" onchange="toggleOtherReason()">
                            <span>Tìm thấy giá tốt hơn ở nơi khác</span>
                        </label>
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="reason" value="Khác" id="reasonOther" onchange="toggleOtherReason()">
