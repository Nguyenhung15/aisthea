                    ...
                    <%@ include file="/WEB-INF/views/admin/include/sidebar_admin.jsp" %>
                                    ...
                                    <c:if test="${empty productList}">
                                        <tr>
                                            <td colspan="8" style="text-align:center; padding: 20px;">
                                                Không tìm thấy sản phẩm nào${not empty param.searchName ? ' khớp với tìm
                                                kiếm' : ''}.
                                            </td>
                                        </tr>
                                    </c:if>
                        ...
                        <div id="deleteModal" class="modal-overlay">
                            <div class="modal-box">
                                ...
                                <p style="font-size: 13px; color: #777;">Thao tác này sẽ xóa vĩnh viễn sản phẩm, bao gồm
                                    tất cả hình ảnh và tồn kho liên quan.</p>
