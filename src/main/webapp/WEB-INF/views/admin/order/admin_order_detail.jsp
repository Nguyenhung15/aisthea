                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .product-info .name {
                                ...
                                color: #333;
                                display: block;
                                /* Đảm bảo tên sp nằm trên 1 dòng riêng */
                            }
                            ...
                            .product-info .sku {
                                ...
                                color: #777;
                                display: block;
                                /* Đảm bảo phân loại nằm trên 1 dòng riêng */
                            }
                    ...
                    <body>
                        <div class="content-container">
                            ...
                            <c:if test="${param.update == 'success'}">
                                <div
                                    style="background: #e8f5e9; color: #2e7d32; padding: 12px; border-radius: 6px; margin-bottom: 20px; font-weight: 600;">
                                    Cập nhật trạng thái thành công!
                                </div>
                            </c:if>
                            <c:if test="${param.update == 'error'}">
                                <div
                                    style="background: #ffebee; color: #c62828; padding: 12px; border-radius: 6px; margin-bottom: 20px; font-weight: 600;">
