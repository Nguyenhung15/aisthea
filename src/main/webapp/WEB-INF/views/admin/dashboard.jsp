                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .stat-card .info strong {
                                font-size: 1.5rem;
                                /* Giảm từ 1.75rem xuống 1.5rem */
                                color: #3e2723;
                                display: block;
                                overflow-wrap: break-word;
                                word-break: break-word;
                                white-space: nowrap;
                                /* Giữ tiền và 'đ' trên 1 dòng */
                            }
                                ...
                                <%-- <div class="filter-bar">
                                    <form action="${pageContext.request.contextPath}/dashboard" method="GET"
                                        ...
                                        <select name="timeRange" id="timeRange">
                                            <option value="all" ${empty param.timeRange || param.timeRange=='all'
                                                ? 'selected' : '' }>Toàn thời gian</option>
                                            <option value="today" ${param.timeRange=='today' ? 'selected' : '' }>Hôm nay
                                            </option>
                                            <option value="week" ${param.timeRange=='week' ? 'selected' : '' }>Tuần này
                                            </option>
                                            <option value="month" ${param.timeRange=='month' ? 'selected' : '' }>Tháng
                                                này</option>
                                        </select>
                                    ...
                                    <tbody>
                                        <c:forEach var="order" items="${recentOrders}">
                                            <tr>
                                                ...
                                                <td><span class="status status-${order.status}">${order.status}</span>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        <c:if test="${empty recentOrders}">
                                            <tr>
                                                <td colspan="4" style="text-align:center; padding: 20px;">Chưa có đơn
                                                    hàng nào.</td>
                                            </tr>
                                        </c:if>
                                    </tbody>
