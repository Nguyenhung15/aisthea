            ...
            <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                ...
                <body class="font-display bg-ombre text-slate-900 min-h-screen">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                                    ...
                                    <section>
                                        ...
                                        <div class="glass-card rounded-xl p-8 space-y-6">
                                            ...
                                            <c:if test="${not empty userAddresses}">
                                                ...
                                                <%-- Fallback: If no default marked, pick the first one from address
                                                    book --%>
                                                    ...
                                                    <div class="min-w-0">
                                                        ...
                                                        <p id="previewAddress"
                                                            ...
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                    <span class="text-amber-500 font-medium italic">Chưa
                                                                        có địa chỉ. Vui lòng thêm mới.</span>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </p>
                                                    </div>
                                            ...
                                            <div id="addressDropdownList">
                                                <div class="space-y-2 pt-2" id="addressSelectionContainer">
                                                    <c:choose>
                                                                ...
                                                                <label
                                                                    ...
                                                                    <div class="flex items-center gap-3 w-full">
                                                                        <input type="radio" name="addressSelection"
                                                                            ...
                                                                            ${addr.addressId==defaultAddr.addressId
                                                                            ? 'checked' : '' } />
                                                        ...
                                                        <c:otherwise>
                                                            <div
                                                                class="p-4 text-center text-sm text-slate-500 italic bg-white/50 rounded-lg border border-dashed border-slate-300">
                                                                Bạn chưa có địa chỉ nhận hàng nào được lưu. Vui lòng
                                                                chọn "Thêm địa chỉ giao hàng khác".
                                                            </div>
                                                        </c:otherwise>
                                                    </c:choose>
                                            ...
                                            <div class="space-y-4">
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <label
                                                        ...
                                                        id="label-card">
                                                        <input checked="" class="sr-only" name="paymentMethod"
                                                            value="Card" type="radio" />
                                                        <span
                                                            class="material-symbols-outlined text-accent-blue mb-3 text-3xl">credit_card</span>
                                                        <span
                                                            class="text-xs font-semibold uppercase tracking-wider">Credit
                                                            Card</span>
                                                    </label>
                                                    <label
                                                    ...
                                                    <label
                                                        ...
                                                        <span
                                                            class="text-xs font-semibold uppercase tracking-wider">Cash
                                                            on
                                                            Delivery</span>
                                                    </label>
                                                </div>
                                                <div class="mt-8 pt-8 border-t border-slate-100">
                                                    ...
                                                    <div id="qrSection"
                                                        ...
                                                        <p class="text-sm text-slate-600 mb-2 font-medium">Professional
                                                            QR
                                                            Payment</p>
                                                        <p class="text-xs text-slate-500">You will be securely
                                                            redirected to
                                ...
                                <div class="lg:col-span-5">
                                    <div
                                        ...
                                        <h2 class="font-serif mb-8 text-slate-800 tracking-wide font-semibold text-3xl">
                                            Your
                                            Order</h2>
                                        <!-- Item List -->
                                            ...
                                            <c:forEach var="item" items="${sessionScope.checkoutCart.items}">
                                                <div class="flex gap-4">
                                                    <div
                                                        ...
                                                        <c:if
                                                            test="${not empty checkoutImg and not fn:startsWith(checkoutImg, 'http') and not fn:startsWith(checkoutImg, '/')}">
                                                            <c:set var="checkoutImg"
                                                                value="${pageContext.request.contextPath}/uploads/${checkoutImg}" />
                                                        </c:if>
                                                        <img class="w-full h-full object-cover" src="${checkoutImg}"
                                                    ...
                                                    <div class="flex-grow">
                                                        ...
                                                        <p class="text-xs text-slate-500 mt-1 italic">${item.color} /
                                                            Size
                                                            ${item.size}</p>
                                                        <div
                                            ...
                                            <%-- Tier membership discount row --%>
                                                <c:if test="${not empty tierDiscountAmount and tierDiscountAmount > 0}">
                                                    <div class="flex justify-between text-sm" id="tierDiscountRow">
                                                        <span
                                                            class="text-amber-600 font-medium whitespace-nowrap overflow-hidden text-ellipsis mr-4 flex items-center gap-1">
                                                            <span class="material-symbols-outlined text-sm">star</span>
                                                            Ưu đãi ${tierName} (${tierDiscountPercent}%)
                                                        </span>
                                                        <span class="text-amber-600 font-medium flex-shrink-0"
                                                            id="tierDiscountDisplay">
                                                            -
                                                            <fmt:formatNumber value="${tierDiscountAmount}"
                                                                type="currency" currencyCode="VND"
                                                                maxFractionDigits="0" />
                                                        </span>
                                                    </div>
                                                    ...
                                                    <%-- Voucher discount row --%>
                                                        <c:if test="${not empty sessionScope.appliedVoucher}">
                                                            <div class="flex justify-between text-sm" id="discountRow">
                                                                <span
                                                                    class="text-emerald-600 font-medium whitespace-nowrap overflow-hidden text-ellipsis mr-4">🎟️
                                                                    ${sessionScope.appliedVoucher.code}
                                                                    <c:if
                                                                        test="${sessionScope.appliedVoucher.discountType eq 'PERCENT'}">
                                                                ...
                                                                <span class="text-emerald-600 font-medium flex-shrink-0"
                                                                    ...
                                                                    -
                                                                    <fmt:formatNumber
                                                                        value="${sessionScope.appliedDiscount}"
                                                                        type="currency" currencyCode="VND"
                                                                        maxFractionDigits="0" />
                                                                </span>
                                                            </div>
                                                        ...
                                                        <c:if test="${empty sessionScope.appliedVoucher}">
                                                            <div class="flex justify-between text-sm hidden"
                                                                id="discountRow">
                                                                <span
                                                                    class="text-emerald-600 font-medium whitespace-nowrap overflow-hidden text-ellipsis mr-4"
                                                                    id="discountCode"></span>
                                                                <span class="text-emerald-600 font-medium flex-shrink-0"
                                                        ...
                                                        <div class="flex justify-between pt-4 border-t border-sky-100">
                                                            ...
                                                            <span class="text-xl font-bold text-slate-900"
                                                                id="totalDisplay">
                                                                <fmt:formatNumber value="${calcTotal}" type="currency"
                        ...
                        <div
                            ...
                            <div class="flex flex-col h-full">
                                ...
                                <div class="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                                    ...
                                    <div class="space-y-3">
                                        <label
                                            class="text-[10px] uppercase tracking-[0.2em] text-slate-400 font-bold">Nhập
                                            mã</label>
                                    ...
                                    <div id="appliedVoucherBox"
                                        ...
                                        <div>
                                            <p class="text-xs font-bold text-emerald-700 uppercase tracking-widest">
                                                ${not
                                                        ...
                                                        <div class="voucher-pick-card relative overflow-hidden rounded-xl border-2 transition-all duration-200 ${canUse ? 'cursor-pointer opacity-100 border-slate-200 bg-gradient-to-br from-white to-blue-50/30' : 'cursor-not-allowed opacity-60 border-slate-100 bg-slate-50'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="material-symbols-outlined text-lg">${vc.discountType
                                                                        eq 'PERCENT' ? 'percent' : 'payments'}</span>
                                                                </div>
                                                                <div style="flex:1;min-width:0;">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${not empty vc.description}">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <c:if test="${not empty vc.endDate}">
                                                                            <span
                                                                                ...
                                                                                <fmt:formatDate value="${vc.endDate}"
                                                                                    pattern="dd/MM/yyyy" />
                                                                            </span>
                                                                        </c:if>
                                                                    ...
                                                                    <c:if
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <fmt:formatNumber
                                                                                ...
                                                                                type="currency" currencyCode="VND"
                                                                                maxFractionDigits="0" /> để dùng mã này
                                                                        </p>
                                                                    </c:if>
                                                                </div>
                        ...
                        if (form) {
                            form.addEventListener('submit', function (e) {
                                ...
                                if (!hiddenAddr || !hiddenAddr.value.trim() ||
                                    ...
                                    e.preventDefault();
                                    showCustomAlert('Vui lòng chọn hoặc nhập địa chỉ giao hàng hợp lệ trước khi đặt hàng.');
                                    return;
                                }
                                ...
                                if (selected === 'Card') {
                                    ...
                                    if (cardNumberInput && expiryDateInput && cvvInput) {
                                        ...
                                        if (!cardNumber && !expiryDate && !cvv) {
                                            e.preventDefault();
                                            showCustomAlert('Vui lòng nhập thông tin thẻ tín dụng (Số thẻ, Ngày hết hạn, CVV).');
                                        ...
                                        if (!/^\d{4}(\s\d{4}){3}$|^\d{16}$/.test(cardNumber.replace(/\s/g, ''))) {
                                            e.preventDefault();
                                            showCustomAlert('Số thẻ không hợp lệ (cần 16 chữ số).');
                                            cardNumberInput.focus();
                                            return;
                                        }
                                        if (!/^(0[1-9]|1[0-2])\/\d{2}$/.test(expiryDate)) {
                                            e.preventDefault();
                                            showCustomAlert('Ngày hết hạn không hợp lệ (định dạng MM/YY).');
                                            expiryDateInput.focus();
                                            return;
                                        }
                                        if (!/^\d{3}$/.test(cvv)) {
                                            e.preventDefault();
                                            showCustomAlert('CVV không hợp lệ (cần 3 chữ số).');
                                            cvvInput.focus();
                                            return;
                                        }
                                    }
                    ...
                    <div id="customAlertModal"
                        class="fixed inset-0 z-[10000] flex items-center justify-center bg-black/50 backdrop-blur-sm hidden text-center"
                        onclick="if(event.target===this)closeCustomAlert()">
                        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-8 transform transition-all duration-300 scale-95 opacity-0"
                            id="customAlertContent">
                            <div class="w-14 h-14 rounded-full bg-red-50 flex items-center justify-center mx-auto mb-4">
                                <span class="material-symbols-outlined text-red-500 text-3xl">error</span>
                            </div>
                            <h3 class="font-serif text-xl text-slate-900 mb-2">Thông báo</h3>
                            <p class="text-sm text-slate-500 mb-6" id="customAlertText"></p>
                            <button type="button" onclick="closeCustomAlert()"
                                class="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-sm font-semibold transition-colors">
                                Đóng
                            </button>
                        </div>
                    </div>
