            ...
            <body>
                    ...
                    <div class="container">
                        <div class="images">
                            ...
                            <div class="thumbnails">
                                <c:forEach var="img" items="${images}">
                                    <img src="${img.imageUrl}" alt="Thumbnail ${img.color}" onclick="changeImage(this)"
                        ...
                        <div class="details">
                            ...
                            <div class="option-group">
                                ...
                                <div class="flex items-center gap-4">
                                    <div
                                        class="flex items-center border border-gray-300 rounded-lg overflow-hidden w-fit">
                            ...
                            <div class="buttons">
                                <button type="submit" class="btn btn-cart opacity-50 cursor-not-allowed"
                                    id="add-to-cart-btn" disabled>
                                    <i class="fa-solid fa-cart-plus"></i> Add to Cart
                                </button>
                                <button type="submit" class="btn btn-buy opacity-50 cursor-not-allowed" id="buy-now-btn"
                ...
                <div class="feedback-section">
                    ...
                    <div class="review">
                        <h4>Nguyễn Minh</h4>
                        <div class="stars">★★★★☆</div>
                        <p>Áo mặc vừa vặn, vải xịn lắm luôn.</p>
                    </div>
                    <div class="review">
                        <h4>Trần Hà My</h4>
                        <div class="stars">★★★★★</div>
                        <p>Siêu đẹp, màu giống hình, rất đáng tiền ❤️</p>
                    </div>
                </div>
                ...
                <script>
                    ...
                    /* <c:forEach var="img" items="${images}"> */
                    colorToImageUrlMap["${img.color}"] = "${img.imageUrl}";
                    /* </c:forEach> */
                    ...
                    function renderSizeOptions() {
                        const uniqueSizes = [...new Set(colorSizeData.map(item => item.size))];
                    ...
                    colorOptionsContainer.addEventListener('click', (e) => {
                        ...
                        if (target) {
                            ...
                            // Nếu size đã chọn không tồn tại trong màu mới thì mới reset
                            if (selectedSize) {
                                const stillExists = colorSizeData.some(item =>
                                ...
                                if (!stillExists) {
                                    selectedSize = null;
                                    sizeOptionsContainer.querySelectorAll('.size-btn')
                    ...
                    function updateAvailableOptions() {
                        ...
                        document.querySelectorAll('.size-btn').forEach(btn => {
                            ...
                            const exists = colorSizeData.some(item =>
                                (!selectedColor || item.color === selectedColor) &&
                                item.size === size &&
                                item.stock > 0
                            );
                            btn.disabled = !exists;
                            btn.classList.toggle('opacity-50', !exists);
                        });
                    ...
                    function handleURLParams() {
                        ...
                        if (params.get('error') === 'stock') {
                            ...
                            msg.className = 'text-blue-800 font-bold mt-6';
