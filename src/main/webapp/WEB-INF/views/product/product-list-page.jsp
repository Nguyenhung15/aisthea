                            ...
                            <c:if test="${priceIsActive}">
                                <span
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>Không có trần</c:otherwise>
                                    </c:choose>
                            ...
                            <div class="space-y-8">
                                ...
                                <div class="filter-section border-b border-primary/10 pb-6">
                                    ...
                                    <div class="accordion-content space-y-4 pl-1">
                                        ...
                                        </div>                                        </div><%-- /accordion-content (categories) --%>
                                    </div><%-- /filter-section category --%>
                                ...
                                <input type="hidden" name="minPrice" id="minPriceHidden" value="${param.minPrice}" />
                                <input type="hidden" name="maxPrice" id="maxPriceHidden" value="${param.maxPrice}" />
                                ...
                                function parsePriceStr(str) {
                                    if (!str) return '';
                                    const parsed = parseInt(str.replace(/\./g, '').replace(/,/g, '').trim());
                                ...
                                function applyPriceFilter() {
                                    ...
                                    if (minVal !== '') {
                                        ...
                                        minH.disabled = true; // prevent sending empty param
                                    }
                                    ...
                                    if (minVal !== '' && maxVal !== '' && minVal > maxVal) {
                                        alert("Lỗi: Giá bắt đầu không thể lớn hơn giá kết thúc!");
                                        return;
                                    }
