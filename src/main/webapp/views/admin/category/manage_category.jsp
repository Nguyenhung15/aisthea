...
<head>
    ...
    <style>
        ...
        .highlight td {
            font-weight: bold;
            color: #3e2723;
            background-color: #f5f5f5; /* Thêm nền nhạt cho dễ phân biệt */
        }
    ...
    <table class="category-table">
        ...
        <tbody>
            <c:forEach var="cat" items="${list}">
                <%-- Sửa lại logic highlight (vì ${empty cat.parentid} cũng đúng khi parentid là chuỗi rỗng) --%>
                <tr class="${empty cat.parentid ? 'highlight' : ''}">
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/category?action=edit&id=${cat.categoryid}"
                           style="color:blue;text-decoration:none;font-weight:600;">✏️ Sửa</a> |
                        ...
                        <a href="${pageContext.request.contextPath}/category?action=delete&id=${cat.categoryid}"
                           ...
                           data-category-name="<c:out value='${cat.name}'/>"> <%-- Thêm tên danh mục --%>
                            🗑️ Xóa
                        </a>
                    </td>
                </tr>
...
<div id="deleteModal" class="modal-overlay">
    <div class="modal-box">
        ...
        <p style="font-size: 13px; color: #777;">
            Cảnh báo: Nếu đây là danh mục cha, các sản phẩm thuộc danh mục con của nó có thể bị ảnh hưởng.
        </p>
