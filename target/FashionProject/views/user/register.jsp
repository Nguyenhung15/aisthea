    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <script>
                ...
                // ✅ Kiểm tra email trùng theo thời gian thực
                ...
                phone.addEventListener('input', () => {
                    ...
                    fetch('${pageContext.request.contextPath}/check-phone?phone=' + encodeURIComponent(value))
                        ...
                        .then(data => {
                            if (data === 'EXISTS') {
                                phoneMsg.textContent = 'This phone number is already used.';
                            } else {
                ...
                password.addEventListener('input', () => {
                    passwordMsg.textContent = password.value.length < 8 ? 'Password must be at least 8 characters.' : '';
                });
                ...
                form.addEventListener('submit', (e) => {
                    if (emailMsg.textContent !== '' || phoneMsg.textContent !== '' || genderMsg.textContent !== '') {
                        e.preventDefault();
